...
function loadPage() {
    ...
    // $(".crystalImages").text("<h1>hi Jessie</h1>")

    // .html function puts text and reads html formatting
    // $(".crystalImages").html("<h1 style='color:red'>hi Jessie</h1>")
    ...
    $(".crystalImages").empty()
    $(".sum").html("<h1>This is your score: " + totalClicks + "</h1>")
    $("#targetNumber").empty()
    ...
    var img1 = $("<img>")
    img1.attr("src", "./assets/images/download-1.png")
    img1.attr("class", "image")
    img1.attr("data-id", Crystal1)
    var img2 = $("<img>")
    img2.attr("src", "./assets/images/download-2.png")
    img2.attr("class", "image")
    img2.attr("data-id", Crystal2)
    var img3 = $("<img>")
    img3.attr("src", "./assets/images/download.png")
    img3.attr("class", "image")
    img3.attr("data-id", Crystal3)
    var img4 = $("<img>")
    img4.attr("src", "./assets/images/redcrystal.png")
